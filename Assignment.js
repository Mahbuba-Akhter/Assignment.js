...
function kilometerToMeter(kilometer) {
    ...
    const meter = kilometer * 1000; // calculate kilometer to meter and store result
    return meter; // return result
}
//call kilometerToMeter function and store return value
const resultMeter = kilometerToMeter(-10);
...
// friend list array
var friends = ['Mahbub', 'Eva rahman', 'Tabassum Hanna', 'Sadia', 'Mim', 'Srishty', 'Junayed', 'Urmi', 'Meherin'];
